                    ...
                    <div className="page-title-box">
                        <Row className="align-items-center">
                            <Col sm="6">
                                ...
                                <Breadcrumb>
                                    <BreadcrumbItem><Link to="#">Feed Fleet</Link></BreadcrumbItem>
                        ...
                        <Col xl="4" md="6">
                            <Card className="directory-card">
                                <CardBody>
                                    ...
                                    <hr />
                                    <p className="mb-0"><b>Intro : </b>At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis atque corrupti quos dolores et... <Link to="/pages-timeline" className="text-primary"> Read More</Link></p>
                                </CardBody>
                            </Card>
                        </Col>
